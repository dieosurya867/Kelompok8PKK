                            ...
                            <form action="" method="POST" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jeniskelamin"
                                            id="inlineRadio1" value="L"  <?php echo ($data['jenis_kelamin'] =='L') ?'checked':'' ?>>
                                        <label class="form-check-label" for="inlineRadio1">Laki - laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jeniskelamin"
                                            id="inlineRadio2" value="P" <?php echo ($data['jenis_kelamin'] =='P') ?'checked':''?>>
                                ...
                                <div class="mb-3">
                                        ...
                                        <label for="pilihkelas">Kelas</label>
                                            ...
                                            <!-- <option selected="<?php echo $data['id_kelas']>$data['nama_kelas'];?>"></option> -->
                                           
                                                <?php
                                                   echo "<option selected =$data[id_kelas]>$data[nama_kelas]</option>";
