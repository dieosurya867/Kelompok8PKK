                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_peminjaman" id="" value="<?= date_format($tanggal_peminjaman, 'Y-m-d') ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Tanggal Pengembalian</label>
                                    <input type="date" class="form-control" name="tanggal_pengembalian" id="" value="<?= date_format($tanggal_pengembalian, 'Y-m-d') ?>">
                                </div>
