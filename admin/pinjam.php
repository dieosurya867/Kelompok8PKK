                        ...
                        <div class="card-body">
                            ...
                            <form action="update_buku.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="judul" id="" value="<?php echo $data['judul'] ?>" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="stok" id="" value="<?php echo $data['total'] ?>">
                                </div>
