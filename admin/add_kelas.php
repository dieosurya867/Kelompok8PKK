...
<body id="page-top">
                        ...
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="id_kelas" id="" placeholder="Masukkan ID Kelas">

                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Nama Kelas</label>
                                    <input type="text" class="form-control" name="nama_kelas" id="" placeholder="Masukkan Nama Kelas">
    ...
    if (isset($_POST['submit'])) {
        ...
        $add = create("kelas", "id_kelas, nama_kelas", "'$id_kelas','$nama_kelas'");
